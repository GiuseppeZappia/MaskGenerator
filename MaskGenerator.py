...
class Mask_Generator(ttk.Frame):
    def __init__(self, mainframe, path):
        ''' Inizializzione del frame principale '''
    ...
    def inizio_selezione(self, event):
            ...
            if(self.radio_var.get()=='p'):
                ...
                #adatto a zoom le coord ma se lo facessi direttamente in poli_punti quando l'utente disegna mentre c'è lo zoom vedrebbe disegno gia
